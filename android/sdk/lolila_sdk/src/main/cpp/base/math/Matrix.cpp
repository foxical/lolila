...
#include "TMatrix.hpp"
#include "FloatOutputAdapter.hpp"
#include <stdexcept>
#include <math.h>
...
Matrix Matrix::elementary_line_transformation(bool& isMostSimplest)const{
    TMatrix<float,FloatOutputAdapter> fm(_items,_row,_col);
    fm.elementary_line_transformation();
    isMostSimplest = fm.isMostSimplest();
    return Matrix(_row,_col,fm.value_ptr());
}
